...
<body>
    ...
    <div id='dblistLeft'>
      ...
      <ul id='listDetail'>
        <li>
          ...
          <ul class='list-sec'>
            <li class='listactive'><a href='/FJleida'><img src="public/img/table.png" alt="" srcset="">雷达</a></li>
            <li><a href='/'><img src="public/img/table.png">探空</a></li>
  ...
  <script src="../public/js/bootstrap-table-zh-CN.js"></script>
	...
	<script src='../public/js/FJleida.js'></script>
</body>
